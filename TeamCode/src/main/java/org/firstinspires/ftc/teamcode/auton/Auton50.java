...
//                                            pivot intake
                ...
                .splineToSplineHeading(new Pose2d(24,-35, Math.toRadians(18)), Math.toRadians(18))
                .forward(12)
                .waitSeconds(0.1)
...
//                                            intake
                ...
                .lineToLinearHeading(new Pose2d(35,-38.5, Math.toRadians(33)))
                .waitSeconds(0.15)
...
//
                ...
                .lineToSplineHeading(new Pose2d(-7,-37,Math.toRadians(270)))
                ...
                .lineToSplineHeading(new Pose2d(-5,-37,Math.toRadians(270)))
                ...
                .lineToSplineHeading(new Pose2d(-3,-37,Math.toRadians(270)))
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    moveLift(900);
                })
                .UNSTABLE_addTemporalMarkerOffset(0.12, () -> {
